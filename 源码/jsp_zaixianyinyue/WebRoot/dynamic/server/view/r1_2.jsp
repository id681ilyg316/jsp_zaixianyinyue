...
<script type="text/javascript">
	...
	function deleteUser(){
		...
		$.messager.confirm("系统提示","您确认要删掉这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("<%=basePath%>/server/ActionR1_deleteLesson.action",{delIds:ids},function(result){
					if(result.success){
	...
	function openUserAddDialog(){
		...
		url="<%=basePath%>/server/ActionR1_addLesson.action";
	}
...
<body style="margin: 5px;">
	<table id="dg" title="我的信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="<%=basePath%>/server/ActionR1_selectLesson2T.action" fit="true" toolbar="#tb">
		<thead>
			<tr>
					<th field="cb" checkbox="true"></th>
					<th field="id" width="5" align="center">编号</th>
					<th field="lesson_name" width="5" align="center">用户名</th>
					<th field="lesson_time" width="5" align="center">密码</th>
					<th field="lesson_need" width="5" align="center">性别</th>
					<th field="lesson_week" width="5" align="center">修改</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			<a href="javascript:openUserAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加管理员</a>
			<a href="javascript:deleteUser()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除管理员</a>
		</div>
	</div>
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px;height: 300px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table align="center">
				<tr>
					<td>用户名</td>
					<td><input type="text" name="lname" id="account" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>密码</td>
					<td><input type="text" name="ltime" id="pwd" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>性别</td>
					<td><input type="text" name="lweek" id="tname" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>用户权限</td>
					<td>
