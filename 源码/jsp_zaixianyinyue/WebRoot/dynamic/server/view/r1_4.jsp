...
<script type="text/javascript">
	...
	function deleteUser(){
		...
		$.messager.confirm("系统提示","您确认要选择这<font color=red>"+selectedRows.length+"</font>些课程吗？",function(r){
			if(r){
				$.post("<%=basePath%>/server/ActionR1_deleteGonggao.action",{delIds:ids},function(result){
					if(result.success){
	...
	function openUserAddDialog(){
		...
		url="<%=basePath%>/server/ActionR1_addGonggao.action";
	}
...
<body style="margin: 5px;">
	<table id="dg" title="我的信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="<%=basePath%>/server/ActionR1_selectGonggao.action" fit="true" toolbar="#tb">
		<thead>
			<tr>
					<th field="cb" checkbox="true"></th>
					<th field="id" width="10" align="center">编号</th>
					<th field="gmsg" width="15" align="center">公告内容</th>
					<th field="gtime" width="15" align="center">公告时间</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			 <a href="javascript:openUserAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加公告</a>
			<a href="javascript:deleteUser()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除公告</a> 
		</div>
	</div>
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px;height: 300px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				<tr>
					<td>公告内容</td>
					<td><textarea rows="10" cols="40" name="gmsg" required="true" ></textarea></td>
				</tr>
			</table>
		</form>
	</div>
