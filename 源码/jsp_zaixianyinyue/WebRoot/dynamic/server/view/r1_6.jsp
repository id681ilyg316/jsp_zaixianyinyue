...
<body style="margin: 5px;">
	<table id="dg" title="视频管理" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="<%=basePath%>/server/ActionR1_selectMusic2.action" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
					<th field="id" width="10" align="center">编号</th>
					<th field="name" width="15" align="center">视频名</th>
					<th field="type" width="15" align="center">视频类型</th>
					<th field="auth" width="15" align="center">视频作者</th>
					<th field="src" width="15" align="center">视频路径</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			<a href="javascript:openUserAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加视频</a>
			<a href="javascript:deleteUser()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除视频</a>
		</div>
	</div>
